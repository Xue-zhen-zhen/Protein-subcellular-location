function [h,p_value] = Ttest(InfoProtein,datatype)

if strcmp(datatype,'literaturedata')
    load('.\data\biomarkerI\\4_classification\\predict\lin_db4_75_205\\N_normal_ALL.mat');
    load('.\data\biomarkerI\\4_classification\\predict\lin_db4_75_205\\N_cancer_ALL.mat');
elseif strcmp(datatype,'HPAdata')
    load('.\data\biomarkerII\\4_classification\\predict\lin_db4_75_205\\N_normal_ALL.mat');
    load('.\data\biomarkerII\\4_classification\\predict\lin_db4_75_205\\N_cancer_ALL.mat');
end
