function [mean_per_evalmodel,indices]=validation_10fold(ttlist,traindata,clabels,testdata,idx_sda)
...
for k=1:10
    ...
    testTarget(1,ind0) = 1;     testTarget(2,ind1)= 1;    % testTarget(2,ind2) = 1;
    index0 = find(predlabels==1); index1 = find(predlabels==2); %index2 = find(predlabels==3);
    preTable(1,index0)= 1;         preTable(2,index1)=1;        % preTable(2,index2)= 1;
