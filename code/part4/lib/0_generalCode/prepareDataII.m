...
switch method
    ...
    case 'classify'
        ...
        addFolder2 = [ 'predict\'  umethod '_' featset '_' patchsize '_' patchnumber];  
    otherwise
...
%                     outputs.statsData{i1}{counter} = ['data\biomarkerI\1_images\' antibodies{i1} '\' conditions{i2} '\' tissues{i3} '\' dirData(i4).name(1:end-3) 'txt'];
                    outputs.statsData{i1}{counter} = ['data\biomarkerII\1_images\' antibodies{i1} '\' conditions{i2} '\' tissues{i3} '\' dirData(i4).name(1:end-3) 'txt'];
