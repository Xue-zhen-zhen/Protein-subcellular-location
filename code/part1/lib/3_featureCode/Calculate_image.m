...
function [feats1, names1] = Calculate_image(nuc,prot, dbtype, NLEVELS) 
...
try
    [ifeat,inames,tfeat,tnames1,wfeat,wnames] = texture_feat_function(protproc,nucproc,prot, dbtype, NLEVELS);
catch err
    rethrow(err)
end
