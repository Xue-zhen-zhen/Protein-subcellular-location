function [mean_per_evalmodel,indices,W,IMage,PredictLabel]=validation_10fold_perimage(ttlist,traindata,clabels,testdata,idx_sda,trainimages,testimages,alabels)  %indices
