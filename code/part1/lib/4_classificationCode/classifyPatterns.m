function classifyPatterns(featPaths, statsData, classes, tissueLabels, writepath,splittype) 
...
% data = zeros( su_fp, 592);  %SLFs features
...
% 7. Classification
if strcmp( splittype, 'per protein')
[mean_per_evalmodel,indices_out,W,IMage,PredictLabel]=validation_10fold(ttlist,traindata,clabels,testdata,idx_sda,...
                            trainimages,testimages,indices); 
end

if strcmp( splittype, 'per image')
    [mean_per_evalmodel,indices_out,W,IMage,PredictLabel]=validation_10fold_perimage(ttlist,traindata,clabels,testdata,idx_sda,...
                            trainimages,testimages,alabels);  
end
disp(classes);
save(finalwritepath,'mean_per_evalmodel','idx_sda','traindata','testdata','clabels','classes','indices_out',...
    'W','IMage','PredictLabel');
