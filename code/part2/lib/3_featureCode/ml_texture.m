...
% V = ML_TEXTURE(I),
%     Returns an array of texture features for image I.返回图像I的纹理特征数组
%     The value for each of the following 13 statistics is下面13个统计数据中的每一个都包含了四个方向的值,这四个方向上的特征的均值和范围也包括在内
...
%
%     1) Angular second moment角二阶矩
%     2) Contrast
%     3) Correlation
%     4) Sum of squares
%     5) Inverse difference moment逆差距
%     6) Sum average
%     7) Sum variance和方差
%     8) Sum entropy和熵
%     9) Entropy
